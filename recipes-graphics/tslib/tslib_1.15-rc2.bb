...
SRC_URI[md5sum] = "8b15b4d37b19a7b0bed4e50c76bb7b3e"
SRC_URI[sha256sum] = "e1c98121fd014be3cba686ce7a325066aaaa1b6fc9aec85c9f12aa02057d7a87"
...
FILES_tslib-tests = "${bindir}/ts_harvest ${bindir}/ts_print ${bindir}/ts_print_raw ${bindir}/ts_test ${bindir}/ts_uinput ${bindir}/ts_verify ${bindir}/ts_test_mt ${bindir}/ts_print_mt ${bindir}/ts_finddev"